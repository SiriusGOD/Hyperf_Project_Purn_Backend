...
class CreateMemberWithdrawTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('member_withdraw', function (Blueprint $table) {
            ...
            $table->decimal('amount', 10)->default(0)->comment('提现金额');
            $table->decimal('trueto_amount', 10)->default(0)->comment('實際收到金額');
            ...
            $table->decimal('coins', 10)->default(0)->comment('提现余额 金币');
