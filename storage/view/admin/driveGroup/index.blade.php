            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                            @if(authPermission('driveGroup-create'))
                                <div class="col-sm-12 col-md-12 mb-1">
                                    <a class="btn badge-info" href="/admin/drive_group/create">{{trans('default.drive_group_control.drive_group_insert') ?? '新增車群'}}</a>
                                </div>
                            @endif
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                    ...
                                    <tr>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Browser: activate to sort column ascending">{{trans('default.drive_group_control.drive_group_name') ?? '車群名稱'}}
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Browser: activate to sort column ascending">{{trans('default.web_url') ?? '網址'}}
                                        </th>
                                        
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                            aria-label="Browser: activate to sort column ascending">{{trans('default.drive_group_control.drive_group_has_class') ?? '所屬車群類別'}}
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1"
                                    ...
                                    @foreach($datas as $model)
                                        <tr class="odd">
                                            ...
                                            <td>
                                                @if(authPermission('driveGroup-edit'))
                                                    <div class="row mb-1">
                                                        <a href="/admin/drive_group/edit?id={{$model->id}}" class="btn btn-primary">{{trans('default.edit') ?? '編輯'}}</a>
                                                    </div>
                                                @endif
                                            </td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">{{trans('default.drive_group_control.drive_group_name') ?? '車群名稱'}}
                                        <th rowspan="1" colspan="1">{{trans('default.image') ?? '圖片'}}</th>
                                        </th>
                                        <th rowspan="1" colspan="1">{{trans('default.web_url') ?? '網址'}}</th>
                                        <th rowspan="1" colspan="1">{{trans('default.drive_group_control.drive_group_has_class') ?? '所屬車群類別'}}</th>
