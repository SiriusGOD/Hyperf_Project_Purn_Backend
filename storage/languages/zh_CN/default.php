...
return [
    ...
    */
    ...
    'member_control' => [
        ...
        'free_quota_msg' => '免费观看次数不能设定超过免费观看次数上限',
        'member_level_msg' => '会员等级持续时间等于1天时，对应观看次数如果没设定则会改为『50次』，如果大于1天，则会改为『空值』'
    ],
    // -------------------------------------------------------------------
    // RoleController
    'role_control' => [
    ...
    'image_group_control' => [
        ...
        'image_group_control_is_delete' => '是否删除',
    ],
    // -------------------------------------------------------------------
    // OrderController
    'order_control' => [
    ...
    'drive_class_control' => [
        'drive_class_control' => '车群类别管理',
        'drive_class_insert' => '新增车群类别',
        'drive_class_name' => '车群类别名称',
        'drive_class_description' => '车群类别描述',
        'drive_class_edit' => '编辑车群类别'
    ],
    // -------------------------------------------------------------------
    // driveGroupController
    'drive_group_control' => [
        'drive_group_control' => '车群管理',
        'drive_group_insert' => '新增车群',
        'drive_group_name' => '车群名称',
        'drive_group_edit' => '编辑车群',
        'drive_group_has_class' => '所属车群类别'
    ],
    // -------------------------------------------------------------------
];
